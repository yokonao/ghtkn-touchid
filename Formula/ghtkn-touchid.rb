class GhtknTouchid < Formula
  ...
  url "https://github.com/yokonao/ghtkn-touchid/archive/refs/tags/v0.2.0.tar.gz"
  sha256 "4eb322d5b03e7aba44ca40f6ac41ad1c816f606899e2a900b3800e67666a16a0"
  license "MIT"
  ...
  def install
    ...
    bin.install "build/ghtkn-touchid"
  end
  ...
  def caveats
    <<~EOS
      ...
      The Keychain item trusts the installed binary, so macOS asks for permission
      once after an upgrade replaces it.
    EOS
  end
